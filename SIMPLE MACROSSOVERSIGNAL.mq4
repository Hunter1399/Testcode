...
int signal_crossower(double a1,double a2,double b1, double b2)
  ...
  int signal_macross()   
 {
  ...
  double ma2_2=iMA(NULL,0,ma2_period,ma2_shift,ma2_method,ma2_price,shift+1); 
  
  
  signal=signal_crossower(ma1,ma1_1,ma2,ma2_2);
